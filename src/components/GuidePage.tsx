  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="border-2 border-foreground">
              <div className="border-b border-foreground px-4 py-2 bg-foreground text-background">
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="border border-foreground p-3">
                    ...
                    <p className="text-xs text-muted-foreground">복습 간격이 길어집니다</p>
                  </div>
                  <div className="border border-foreground p-3">
                    <p className="font-semibold text-sm">애매해요</p>
                    <p className="text-xs text-muted-foreground">더 자주 복습합니다</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="border-2 border-foreground p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center">
              <div className="border border-foreground p-3">
                ...
                <p className="text-xs text-muted-foreground">처음 학습</p>
              </div>
              <div className="border border-foreground p-3">
                <p className="font-mono text-lg font-bold">3일</p>
                <p className="text-xs text-muted-foreground">첫 복습 후</p>
              </div>
              <div className="border border-foreground p-3">
                <p className="font-mono text-lg font-bold">7일+</p>
                <p className="text-xs text-muted-foreground">연속 정답 시</p>
              </div>
            </div>
      ...
      <footer className="border-t-2 border-foreground mt-8">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <button
            className="w-full py-3 border-2 border-foreground hover:bg-foreground hover:text-background transition-colors text-sm uppercase tracking-wider"
            onClick={onBack}
          >
            대시보드로 돌아가기
          </button>
